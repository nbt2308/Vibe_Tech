        ...
        <div
            ...
            <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 relative">
                <div class="flex items-center">
                    <h3 class="text-blue-600 text-xl font-semibold flex-1">Thêm mới danh mục</h3>
                ...
                <form class="space-y-6 mt-8" action="{{ route('admin.categories.store') }}" method="POST"
                    ...
                    <div>
                        <label class="text-slate-900 text-sm mb-2 block">Ảnh đại diện cho danh mục (Thumbnail)
